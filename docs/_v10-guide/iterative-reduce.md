...
short_title: Iterative Reduce
description: Iterative algorithm for distributed processing.
category: Tuning & Training
weight: 10
---

## Understanding Iterative Reduce through MapReduce
...
Every form of scaleout including Hadoop and Spark is included in our [scaleout repository](https://github.com/deeplearning4j/deeplearning4j/tree/master/deeplearning4j/deeplearning4j-scaleout).
