...
RNNs은 애니메이션으로 시각화하면 쉽게 이해할 수 있습니다. 아래 애니메이션을 참고하시기 바랍니다. 혹시 그림이 뜨지 않는다면 [이 링크](http://imgur.com/kpZBDfV)를 누르세요.
...
* [아이겐벡터, 공분산, 주성분분석, 엔트로피](eigenvector)
